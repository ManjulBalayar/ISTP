...
def query_social_capital_data(request, town, specific_demographic, soc_data_type, year):
    try:
        ...
        soc_prefix_mapping = {
            'Close friends in the community': 'scfriends',
            'Adult relatives and in-laws in the community': 'screlatives',
            'Community is supportive instead of indifferent': 'scsupportive',
            'Local clubs and organizations interested in what is best for all residents': 'scorgsworkall',
            'Community receptive to new residents taking leadership positions': 'scnewresleader',
            'Community is open to new ideas instead of rejecting new ideas': 'scopenideas',
            'Belonging in local organizations': 'sclocalorg',
            'Belonging in non-local organizations': 'scoutsideorg',
            'Involvement in local activities and events': 'scactiveorg',
            'Involvement in local or outside organizations': 'sclocoutorg',
            'Volunteering in community projects last year': 'cevolunteer',
            'When something needs to get done, whole town gets behind it': 'cetowngetsbehind',
            'Everyone can contribute to local government affairs if they want to': 'ceinvolvdecisions',
            'I would feel sorry if I had to leave this community': 'casorryleave',
            'I feel at home in this community': 'cafeelhome',
            'Living in this town is like being with a close group of friends': 'catownlikefriends',
            'Town has a lot going for it compared to other towns of a similar size': 'csmoregoforit',
            'Community is well-kept instead of run-down': 'cswellkept',
            'If you don\'t look out for yourself in this town, no one else will': 'cslookoutforself',
            'Where do you go for primary health care': 'goservprimhealth',
            'Where do you go for specialized health care': 'goservspechealth',
            'Where do you go to shop for daily needs': 'goservshopdaily',
            'Where do you go to shop for big ticket items': 'goservshopbig',
            'Where do you go for entertainment and recreation': 'goservrecent',
            'Where do you go to attend church or worship services': 'goservchurch',
            'Reasons not getting involved: do not have the time': 'novolnotime',
            'Reasons not getting involved: do not have the needed skills': 'novolnoskills',
            'Reasons not getting involved: do not know how to volunteer': 'novoldnkhow',
            'Reasons not getting involved: tried to volunteer, but help not accepted': 'novolhelprefused',
            'Reasons not getting involved: I have no interest in volunteering': 'novolnointerest',
            'Reasons not getting involved: no one asked me to volunteer': 'novolnotasked',
            'Reasons not getting involved: there are no projects that need volunteers': 'novolnoproject'
        }
